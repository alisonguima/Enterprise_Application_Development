...
public class CadastroTeste3 {
	public static void main(String[] args) {
		...
		//1 - Cadastrar um aluno com um grupo que ja existe no banco
		...
		//2 - Associar um aluno à um curso que ja existem no banco
		
		//Obeter um CursoDao
		GenericDao<NanoCourse, Integer> cursoDao = new GenericDaoImpl<NanoCourse, Integer>(em) {};
		
		try {
			//Pesquisar um curso
			NanoCourse nano = cursoDao.search(1);
			
			//Pesquisar um aluno
			Aluno aluno = alunoDao.search(2);
